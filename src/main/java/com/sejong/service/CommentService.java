...
public class CommentService {
     ...
     */
    @Transactional
    public Comment createComment(@org.springframework.lang.NonNull Integer inquiryId, String content) {
     ...
     */
    @Transactional
    public Comment updateComment(@org.springframework.lang.NonNull Integer commentId, String content) {
     ...
     */
    @Transactional
    public void deleteComment(@org.springframework.lang.NonNull Integer commentId) {
        Comment comment = commentRepository.findById(commentId)
                .orElseThrow(() -> new EntityNotFoundException("답변을 찾을 수 없습니다."));
